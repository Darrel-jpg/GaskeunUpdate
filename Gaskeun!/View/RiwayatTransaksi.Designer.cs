namespace Gaskeun_.View
{
    partial class RiwayatTransaksi
    {
        ...
        private void InitializeComponent()
        {
            ...
            dataGridView1.Columns.AddRange(new DataGridViewColumn[] { Username, JenisKendaraan, NamaKendaraan, TanggalSewa, TanggalKembali, TanggalKeterlambatan, Jaminan, Durasi, PaketSewa, Denda, Harga });
